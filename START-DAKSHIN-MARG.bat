...
title DAKSHIN MARG Launcher
cd /d "%~dp0"

echo ============================================================
echo  DAKSHIN MARG  -  Antarctic Navigation Decision Support System
...
start "DAKSHIN MARG - Python env/ML API :8100" /d "%~dp0python-services" cmd /k python -m uvicorn env_data.api:app --host 0.0.0.0 --port 8100
start "DAKSHIN MARG - Node application API :8200" /d "%~dp0backend" cmd /k npm run start
start "DAKSHIN MARG - Web app :4173" /d "%~dp0frontend" cmd /k npm run preview
...
echo.
echo ============================================================
echo  DAKSHIN MARG is running:   http://localhost:4173
echo.
