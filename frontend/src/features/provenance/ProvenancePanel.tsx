...
const STATIC_PROV: Prov[] = [
  { id:'R-1042', kind:'Route', source:'POLARIS-X optimizer severity-ceiling-astar v0.1.0', product:'Route plan · Prydz Bay corridor', observedAt:'2026-09-01T00:00Z', ingestedAt:'2026-09-01T03:12Z', servedAt:'2026-09-02T06:00Z', crs:'EPSG:4326 / EPSG:3031', resolution:'0.5°×0.25° (~14×28 km)', version:'R-1042 v3', quality:'ok', age:'3.2 h', provenance:'DERIVED_FROM_OBSERVATION' },
  { id:'F-293', kind:'Forecast', source:'POLARIS-X damped-trend v0.1.0', product:'SIC +48h forecast', observedAt:'2026-09-01T00:00Z', ingestedAt:'2026-09-01T03:15Z', servedAt:'2026-09-02T06:01Z', crs:'EPSG:4326', resolution:'0.5°×0.35°', version:'SIC-CONVLSTM-12 (experimental)', quality:'ok', age:'5 h', provenance:'MODEL_FORECAST' },
